...
* [`src/front/`](src/front/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/front/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `front` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/front/config.cljs) defaults to `true` in
...
```clj
(ns front.example
  (:require [front.config :as config])
